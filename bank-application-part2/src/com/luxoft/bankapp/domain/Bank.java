...
public class Bank implements Serializable {
    ...
    public Bank() {
        // TODO - Exercise 3 - Replace the listeners from the Bank class with anonymous classes
        ...
        listeners.add(new ClientRegistrationListener() {
            ...
            public void onClientAdded(Client client) {
                ...
                if (emailService != null) {
                    try {
                        emailService.sendNotificationEmail(new Email().setFrom(system).setTo(admin).setCopy(client).setTitle("Client Added Notification").setBody("Client added: " + client));
    ...
    // TODO - replace listener with lambda expresion
    /*
